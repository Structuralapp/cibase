.PHONY: cibase-3.1 cibase-3.0 cibase-2.0 cibase-tf-2.0 cibase-1.5 cibase-1.4 cibase-1.3 cibase-1.2 cibase-1.1 cibase-1.0

cibase-3.1:
	docker build -t structural/cibase:3.1 -f cibase-3.1.dockerfile .
